...
测试`Demo.java`, `endpoint,ACCESS_KEY_ID,ACCESS_KEY_SECRET,bucketName`  这四个从阿里云开通获取
...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String ACCESS_KEY_ID="skdjfksdjfl";
        String ACCESS_KEY_SECRET="ddddd";
        // 填写Bucket名称，例如examplebucket。
        String bucketName = "big-event-rangumo";
        ...
        try {
            ...
            PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, objectName, new FileInputStream("C:\\Users\\Administrator\\Desktop\\files\\001.png"));
...
public class AliOssUtil {
    ...
    // 从环境变量中获取访问凭证。运行本代码示例之前，请确保已设置环境变量OSS_ACCESS_KEY_ID和OSS_ACCESS_KEY_SECRET。
    //EnvironmentVariableCredentialsProvider credentialsProvider = CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider();
    private static final String ACCESS_KEY_ID="sdssdsd";
    private static final String ACCESS_KEY_SECRET="dd";
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKET_NAME = "big-event-rangumo";
